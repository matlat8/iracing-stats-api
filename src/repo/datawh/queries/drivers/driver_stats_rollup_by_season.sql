select
    ...
    round(avg(if(sr.simsession_type = 6, sr.laps_complete, null)), 2) as irating_events_avg_laps_completed,
    round(avg(sr.finish_position_in_class)+ 1, 2)  as avg_finish_position_in_class,
    round(avg(sr.starting_position_in_class)+ 1, 2)  as avg_start_position_in_class
